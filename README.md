...
##### Поступив на курсы я решил поменять свою сферу деятельности на то , что нравится, то что интересно. На курсах я понял, что значит структурированнный и красивый код. В своих учебных проектах я использовал "крайние" технологии, которые делали код красивым и функциональным.  
